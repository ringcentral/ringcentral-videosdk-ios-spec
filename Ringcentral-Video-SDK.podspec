...
Pod::Spec.new do |s|
  ...
  s.source       = { :http => 'https://github.com/ringcentral/ringcentral-videosdk-ios-spec/releases/download/v0.14.2/RingCentral_Video_iOS_Client_SDK.zip',
    :sha1 => 'd99f3cd1774e73a11c1864479e568de803b163d4',
    :flatten => true }
