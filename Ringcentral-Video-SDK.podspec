...
Pod::Spec.new do |s|
  ...
  s.source       = { :http => 'https://github.com/ringcentral/ringcentral-videosdk-ios-spec/releases/download/v0.14.1/RingCentral_Video_iOS_Client_SDK.zip',
    :sha1 => 'e3d3080fc0afd6e5ae47e1c62a0a60fca32afbfd',
    :flatten => true }
