...
Pod::Spec.new do |s|
  ...
  s.source       = { :http => 'https://github.com/ringcentral/ringcentral-videosdk-ios-spec/releases/download/v0.11.0/RingCentral_Video_iOS_Client_SDK.zip', 
    :sha1 => '3468ea891d9de96b6864059c853f3a7ee9e1c652',
    :flatten => true }
